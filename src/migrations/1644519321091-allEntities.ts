...
export class allEntities1644519321091 implements MigrationInterface {
    name = 'allEntities1644519321091'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "sells" ("id" SERIAL NOT NULL, "clientName" character varying NOT NULL, "clientEmail" character varying NOT NULL, "totalPrice" integer NOT NULL DEFAULT '0', "createdOn" TIMESTAMP NOT NULL DEFAULT now(), "cartId" integer, "userId" uuid, CONSTRAINT "REL_89850b75004a2cdc7f0254aa6c" UNIQUE ("cartId"), CONSTRAINT "PK_98dae8a080bb62a676f24e0dee0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "cart" ("id" SERIAL NOT NULL, "cartOwner" character varying NOT NULL, "products" text array NOT NULL DEFAULT '{}', "createdOn" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "REL_756f53ab9466eb52a52619ee01" UNIQUE ("userId"), CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`);
